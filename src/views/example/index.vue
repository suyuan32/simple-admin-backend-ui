...
<script lang="ts">
  ...
  import { getStudentList, deleteStudent, batchDeleteStudent } from '/@/api/example/student';

  export default defineComponent({
    name: 'StudentManagement',
    components: { BasicTable, StudentDrawer, TableAction, Button },
    setup() {
      const { t } = useI18n();
      ...
      async function handleBatchDelete() {
        Modal.confirm({
          ...
          async onOk() {
            const result = await batchDeleteStudent(
